...
function _setProject {
    #---- project settings -----
    readonly OPTOUTPUTNAME_DEFAULT=catena-4430-mfgtest-complete
    ...
    readonly OPTARDUINO_SOURCE_DEFAULT=sketches/catena4430-mfgtest-complete/catena4430-mfgtest-complete.ino
}
